...
MyGame.graphics = (function() {
    ...
    function drawSprite(image, startClip, sizeClip, center, rotation, size){
        context.save();
        context.translate(center.x, center.y);
        context.rotate(rotation);
        context.translate(-center.x, -center.y);
        ...
        context.drawImage(
            image,
            startClip.x, startClip.y,
            sizeClip.x, sizeClip.y,
            center.x - size.width / 2,
            center.y - size.height / 2,
            size.width, size.height);
    ...
    function drawText(text, font, size, color, x = canvas.width/3.5, y = canvas.height/1.9){
